objectdef obj_TargetingDatabase inherits obj_StateQueue
{
	...
	method InstantiateTargetingTable(string TableName, int64 TableUpdateInterval, string TableQueryString, int64 MinimumLocks)
	{
		...
		TargetingDatabase:ExecDML["insert into Origin (TableName, TableQueryString, MinimumLocks, TableLastUpdate, TableUpdateInterval, QueryChanged) values ('${TableName}', '${TableQueryString}', ${MinimumLocks}, 000000000, ${TableUpdateInterval}, 1);"]
